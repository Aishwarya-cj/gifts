  ...
  return (
    <div className={`flex flex-col items-center gap-1.5 ${className}`}>
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-white/90 backdrop-blur-md border border-white/80 shadow-sm"
      >
        <span className="text-xs sm:text-sm font-semibold tracking-wider text-rose-950 uppercase">
      ...
      <div className="w-28 sm:w-36 h-1.5 rounded-full bg-black/25 overflow-hidden backdrop-blur-sm border border-white/50">
        <motion.div
